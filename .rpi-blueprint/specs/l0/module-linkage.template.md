...
> 模块、服务、包或上下文只是实现边界；Capability 表达稳定用户能力。不要把目录结构自动等同于产品能力。
...
- [ ] 记录全局操作日志
- [ ] 更新联动关系表
- [ ] 记录幂等键、并发冲突、超时和部分失败策略
- [ ] 更新受影响 Capability/Invariant 与契约测试
